...
oS.Init({
	...
	ZName: [oIZombie, oIConeheadZombie, oIBucketheadZombie, oIDuckyTubeZombie1, oIDuckyTubeZombie2, oIDuckyTubeZombie3, oIScreenDoorZombie, oIPoleVaultingZombie, oIBalloonZombie],
	...
	LvlEName: "izombie10",
	LoadMusic: "Cerebrawl", StartGameMusic: "Cerebrawl",
	ArP: {
	...
	RiddleAutoGrow: function() {
        ...
        for (var i = f[0]; i <= f[1]; ++i) CustomSpecial(oILilyPad, 3, i), CustomSpecial(oLilyPad, 4, i); // 荷叶
