let coolerPeashooter = oPeashooter;
// dirty fix for preloading peashooter as a zombie
coolerPeashooter.prototype.Init = function () {
	// do nothing lol
};
// dirty fix to make it plantable
coolerPeashooter.prototype.CustomBirth = function (c, d, b, a) {
	// do a customspecial instead
	let ele = CustomSpecial(oPeashooter, c, d).plantImage;
	ele.classList.add("cardboard");
};
oS.Init({
	PName: [oPeashooter, oSunFlower, oSnowPea, oSquash],
	ZName: [oIZombie, oIBucketheadZombie, oIFootballZombie, coolerPeashooter],
