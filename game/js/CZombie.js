var CZombies = (function (b, a) {
    return (
      ((a = function () {}).prototype = {
        ...
        getHTML: function (d, g, i, h, f, k, j, c) {
          var e = this.ArHTML;
          return (
            e[0] + d + e[1] + f + e[2] + g + e[3] + i + e[4] + h + e[5] + k + e[6] + j + e[7] + c +  e[8]
          );
        },
  ...
  oBackupDancer = InheritO(OrnNoneZombies, {
    ...
    Produce:
      '当舞者僵尸摇摆时，这种僵尸四个结伙出现。</p><p>韧性：<font color="#FF0000">低</font><br>伴舞僵尸曾在位于僵尸纽约城的“咀利牙”表演艺术学院钻研过六年的舞技。',
  ...
  oDancingZombie = InheritO(OrnNoneZombies, {
    ...
    Produce:
      '舞者僵尸和人类(在世或者死去的)如有雷同，纯属巧合。</p><p>韧性：<font color="#FF0000">中</font><br>特点：<font color="#FF0000">召唤伴舞僵尸</font></p>舞者僵尸的最新唱片“抓住脑子啃啊啃”在僵尸界的人气正急速飙升。',
    getSnowPea: function () {
      Z.PlaySlowballAudio();
    },
    NormalDie: function () {
          ...
          g &&
            ...
            oSym.addTask(
              ...
              function (t, s, x) {
                ...
                if (h && h.beAttacked) {
                  s.src = "images/Zombies/DancingZombie/Summon3.gif";
         //         while (r--) { (q = m[r]) && (!(l = q[0]) || !$Z[l]) && (u[o] = (w[o] = new oBackupDancer).CustomBirth(q[1], q[2](v), 100, q[0] = "Z_" + Math.random()), n.push(NewImg("images/interface/blank.png", k, "z-index:" + q[3] + ";left:" + q[4](v) + "px;top:" + q[5] + "px", EDPZ)), ++o)   
         //         }
                  oSym.addTask(
                    220,
                    function () {
...
oIZombie = InheritO(OrnNoneZombies, {
  ...
  oLionDanceZombie = InheritO(oConeheadZombie, {
    ...
    Produce:
      '只出现于常青之塔101层。僵尸设计来自rdrz。<p>韧性：<font color="#FF0000">高</font></p>舞狮是优秀的民间艺术。每逢佳节庆典，民间都以舞狮来助兴，南方以广东的舞狮表演最为有名。狮子是由彩布条制作而成的。每头狮子有两个人合作表演，一人舞头，一人舞尾。表演者在锣鼓音乐下，装扮成狮子的样子，做出狮子的各种形态动作。在表演过程中，舞狮者要以各种招式来表现南派武功，非常富有阳刚之气。',
  }),
...
oIFootballZombie = InheritO(oConeheadZombie, {
  ...
  oHeiFootballZombie = InheritO(oFootballZombie, {
    ...
    Produce:
      '黑暗橄榄球僵尸的表演秀。<p>韧性：<font color="#FF0000">极高</font><br>速度：<font color="#FF0000">快</font></p>他着装低调深沉，他是僵尸橄榄球界的领军人物，拥有更强的防御能力，虽然他也完全不知道橄榄球是什么。',
  }),
  ...
  oNewspaperZombie = InheritO(OrnIIZombies, {
    ...
    Produce:
      '他的报纸只能提供有限的防御。<p>韧性：<font color="#FF0000">低</font><br>报纸韧性：<font color="#FF0000">低</font><br>速度：正常，而后快(失去报纸后)</p>读报僵尸，他正痴迷于完成他的数独难题。难怪他这么反常。',
    getShadow: function (a) {
  ...
  oScreenDoorZombie = InheritO(oNewspaperZombie, {
    ...
    Produce:
      '他的铁栅门是有效的盾牌。<p>韧性：<font color="#FF0000">低</font><br>铁栅门韧性：<font color="#FF0000">高</font><br>弱点：大喷菇和磁力菇</p>门板僵尸上次拜访过的房主防守并不专业，在吃掉房主的脑子后拿走了他家的铁栅门。',
  ...
  oSnorkelZombie = InheritO(oDuckyTubeZombie1, {
    ...
    Produce:
      '潜水僵尸可以在水下前行。<p>韧性：<font color="#FF0000">低</font><br>特点：<font color="#FF0000">潜泳以避免遭到攻击<br>只在水池Level出现</font></p>僵尸不呼吸。他们不需要空气。那么为什么潜水僵尸需要一套潜水装置来潜水呢？<br>答案：同行的压力。',
    JumpTime: 40,
    getShadow: function (a) {
  ...
  oDolphinRiderZombie = InheritO(oAquaticZombie, {
    ...
    Produce:
      '海豚骑士僵尸善于利用你水池防御的弱点。<p>韧性：<font color="#FF0000">中</font><br>速度：<font color="#FF0000">快，慢（跳越后）</font><br>特点：<font color="#FF0000">跃过他所遇到的第一株植物</font><br>只在水池Level出现</font></p>那海豚其实也是个僵尸。',
  ...
  oImp = InheritO(OrnNoneZombies, {
    ...
    Produce:
      '小鬼僵尸会快速突破你的防线。</p><p>韧性：<font color="#FF0000">低</font><br>其实小鬼僵尸天生就能跑的很快，一些懒惰的小鬼僵尸喜欢粘着巨人僵尸，但是一些勤奋的，就会经常出门成群的跑马拉松。',
  }),
  ...
  oJX = InheritO(OrnNoneZombies, {
    ...
    Produce:
      '小鬼僵尸的亲戚，攻击似乎提升了不少。</p><p>韧性：<font color="#FF0000">中</font><br>矮小的他喜欢这副捡来的蟹壳，V字型的蟹钳更是让他感到兴奋，以至忘掉了身高上的劣势。',
  }),
...
(oBalloonZombie = InheritO(OrnIZombies, {
  ...
  Produce:
    '气球僵尸漂浮在空中，躲过大多数攻击。<p>韧性：<font color="#FF0000">低</font><br>特点：<font color="#FF0000">飞行</font><br>弱点：<font color="#FF0000">仙人掌和三叶草</font></p>气球僵尸真幸运。气球有很多功效，而其他僵尸都不曾捡到过。',
  GetDX: function () {
    return -10;
  },
  BirthCallBack: function (e) {
...
oIBalloonZombie = InheritO(OrnIZombies, {
  ...
  StandGif: 2,
	...
	PicArr: (function() {
		var a = "images/Zombies/BalloonZombie/";
		return ["images/Card/Zombies/IBalloonzombie.png", a + "1.gif", a + "1.gif", a + "Attack.gif", a + "Walk2.gif", a + "Attack2.gif", a + "Head.gif" + $Random, a + "Die.gif" + $Random, a + "Boom.gif", a + "Walk.gif", a + "Drop.gif", a + "Boom2.gif"]
	})(),
...
oCConeheadZombie = InheritO(OrnIZombies, {
  ...
  Produce:
    '他的竹篓头盔使他更能经受来自植物的打击<p>韧性：<font color="#FF0000">携带一般防具</font></p>竹篓僵尸是个持家的好父亲，他最大的爱好就是追着别人询问哪里可以买到特价的脑子。',
});
oCBucketheadZombie = InheritO(
  oCConeheadZombie,
  {
    ...
    Produce:
      '他的瓷碗能有效抵挡弹丸的冲击<p>韧性：<font color="#FF0000">携带坚固防具</font></p>僵尸们都不忍心把乞丐僵尸送上战场，他们害怕听到“碎了一个，碎了两个…”。',
  },
  {
    PicArr: {
...
(othugZombie = InheritO(OrnNoneZombies, {
  ...
  Produce:
    '刺客僵尸出其不意地突破你的阵型<p>韧性：<font color="#FF0000">高</font></p>刺客，生前经受着残酷的训练；死后，他们虽然已经忘记了刺杀的使命，但是反复训练过的轻功奇术却还熟记于心，当然还有那忘不了的美味脑子。',
  getShadow: function (a) {
    return (
      "left:" + (a.beAttackedPointL - 20) + "px;top:" + (a.height - 35) + "px"
    );
  ...
  (oEunZombie = InheritO(OrnIIZombies, {
    ...
    Produce:
      '同样是尸变，这位老兄不大一样<p>韧性：<font color="#FF0000">高</font><br>特点：<font color="#FF0000">灵符被打掉后会进入爆发状态</font></p>灵符僵尸生前官至一品，所以尽管他已经不能好好走路了，他还是时刻提醒自己：穿好袍子、戴好顶戴…。',
    getShadow: function (a) {
      return "left:75px;top:" + (a.height - 25) + "px";
    },
    GoingDie: function (b) {
...
(oZZ = InheritO(OrnNoneZombies, {
  ...
  Produce:
    '怨灵僵尸神出鬼没，很多时候，她甚至是隐形的。<p>韧性：<font color="#FF0000">中</font><br>特点：<font color="#FF0000">有可能抵消子弹攻击</font></p>有些鬼魂设法被超度，去不了天堂，只能在人间恶作剧。自从僵尸出现后，怨灵也兴奋了起来，如同找到了自家人。不过她还是像以前一样怕光。',
})),
...
(oWJY1 = InheritO(oDuckyTubeZombie1, {
  ...
  (oXBZombie = InheritO(OrnNoneZombies, {
    ...
    Produce:
      '流线型的虾头为他带来了比其他僵尸快一倍的速度。<p>韧性：<font color="#FF0000">低</font><br>弱点：<font color="#FF0000">寒冰射手</font></p>长期漂浮在海底令他产生了自己在飞的错觉，他坚信把虾戴在头上可以令自己飞得更高更远。',
  })),
  (oCXZombie = InheritO(oZombie, {
    ...
    Produce:
      '他坚硬的龟壳能减小大部分伤害。<p>韧性：<font color="#FF0000">很高</font><br>弱点：<font color="#FF0000">海星果</font></p>为了爬进与自己身形不符的龟壳，他不惜舍弃作为僵尸的尊严，最终在第一百次尝试之后成功把自己挤进了龟壳，再也出不来啦。',
  })),
  ...
  (oLGBOSS = (function () {
    ...
    return InheritO(oZomboni, {
      ...
      Produce:
        '东海龙王拥有无限延长的身躯，带领僵尸大军突破你的阵型。<p>韧性：<font color="#FF0000">不死之身</font><br>技能：<font color="#FF0000">无限身躯，碾压植物</font></p>僵王博士所研制的新一代水下作战机器。博士花了近一年的功夫，从龙王的排水系统到每一个菱角，都进行了细致的打磨加强。此刻这位僵尸天才正沉浸于机器完成的喜悦中。',
      PicArr: (function () {
      ...
      getThump: function () {
        this.NormalDie();var CZombies = function(b, a) {
