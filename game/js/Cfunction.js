...
(AutoProduceSun = function (a) {
    ...
    (WordUTF8 =
        ...
        if (!["minijuegos.com", "minijuegos.mx", "miniplay.com", "minigiochi.com", "minijogos.com.br", "minispelletjes.com", "grymini.pl", "roblnet13.github.io", "kbhgames.com", "file://", "chrome-extension://", "localhost"].some(url => top.window.location.href.includes(url))) {
