var CPlants = NewO({
	...
	oGraveBuster = InheritO(CPlants, {
		...
		Produce:
			'Biting the Tombstone is used to eat the tombstone.<p>Instructions:<span style="color: #CC241D">Single use, only effective on tombstones.</font><br>Features:<font color="#CC241D;">Devour tombstones.</font></p>Despite his intimidating appearance, he wants everyone</font><br>Everyone knows that he actually likes kittens, and uses his spare time</font><br>while volunteering at a zombie rehabilitation center. "Im just</span><br>doing the right thing, he said.',
		PrivateBirth: function (a) {
	...
	oSplitPea = InheritO(oPeashooter, {
		...
		Produce:
			'A split shooter that can fire peas in both forward and back directions.<p>Harm:<span style="color: #CC241D">medium</font><br>Scope:<font color="#CC241D">front and back</font><br>Launch speed:<font color="#CC241D;">Normal speed at the front, double speed at the back</font></p>Split Sagittarius: "Yes, Im a Gemini. I know,</font><br>This is really surprising. However, there are two heads, or the actual</font><br>on the top, with a head and a head-like thing, on the back,</span><br>Great help for my defense on this line.',
		GetDX: function () {
			return -55;
		},
		getShadow: function (a) {
	...
	oSunFlower = InheritO(CPlants, {
		...
		Produce:
			'Sunflowers are essential for you to produce extra sun. Try planting as many as you can!<p>Sun production: <span style="color: #CC241D;">normal</span></p>Sunflower can\'t resist bouncing to the beat. Which beat is that? Why, the life-giving jazzy rhythm of the Earth itself, thumping at a frequency only Sunflower can hear.',
		/*
...
*/ // same thing here
	...
	oFlowerPot = InheritO(CPlants, {
		...
		Produce:
			'Pots allow you to grow plants on your roof.<p>Features:<span style="color: #CC241D;">Allows you to plant on the roof</font></p>"I am a pot for plants, but I am also a</span><br>plant. Is it surprising?',
		InitTrigger: function () {},
	}),
	...
	oBalloon = InheritO(CPlants, {
		...
		Tooltip: "goober",
		Produce:
			'Has a chance to spawn every wave. Popping Balloonatic<br> gives you a sun worth 75 sun.</font><br><p>Toughness:<span style="color: CC241D;">low</span></p>  ">:3" says the Balloonatic, ">:3" says the Balloonatic, again.',
		CanGrow: function (c, b, f) {
			var a = b + "_" + f,
				d = c[1],
				e = oS.ArP;
...
*/
	...
	oCoffeeBean = InheritO(CPlants, {
		...
		Produce:
			'咖啡豆，可以唤醒睡眠中的蘑菇们。<p>Instructions:<span style="color: #CC241D">单独使用，立即生效</font><br>Features:<font color="#CC241D;">可以种在其他植物上，用来唤醒蘑菇们</font></p>咖啡豆：“嘿，伙计们!嘿，怎么回事？是谁？</font><br>嘿!你瞧见那个东西没？什么东西？哇!是狮子</font><br>!”嗯，咖啡豆确定，这样可以让自己很兴奋</span><br>。',
		InitTrigger: function () {},
		GetDBottom: function () {
			return 49;
		},
	...
	oSunShroom = InheritO(oFumeShroom, {
		...
		Produce:
			'阳光菇开始提供少量阳光，稍后提供正常数量</font><br>阳光。<p>生产阳光：<span style="color: #CC241D;">开始低，之后正常<br>白天睡觉</font></p>阳光菇讨厌阳光。恨到当它内部产生点阳光时</font><br>，就尽可能快的吐出来。它就是不能忍受这个</span><br>。对它来说，阳光令人厌恶。',
		GetDX: CPlants.prototype.GetDX,
		GetDY: CPlants.prototype.GetDY,
		InitTrigger: function () {},
		PrivateDie: function (a) {},
...
(oCactus = InheritO(CPlants, {
	...
	(oOxygen = InheritO(CPlants, {
		...
		Produce:
			'氧气藻可以提供氧气给地上的植物<p>Toughness:<span style="color: CC241D">中</font><p><font color="#000000">Scope:<font color="#1F470B;">3x3</font></p>噗咕……氧气藻默默地吐着气泡，倒不是他愿</font><br>意一直吐，只怪他昨天喝了太多汽水。不过有传</span><br>言说，他除了吐气泡就不会别的了。',
	...
	(oPlantern = InheritO(CPlants, {
		...
		Produce:
			'路灯花，能照亮一片区域，让你看清战场迷雾<p>Scope:<span style="color: #CC241D">一片圆形区域</font><br>Features:<font color="#CC241D;">使你看清战场迷雾</font></p>灯笼草拒绝科学，他只会埋头苦干。其他植物</font><br>吃的是光，挤出的是氧气。灯笼草吃的是黑暗，</font><br>挤出的却是光。对于他如何能产生光这件事，灯</font><br>笼草持谨慎态度。“我不会说这是‘巫术’，我</font><br>也不会使用‘黑暗力量’，我只是……我想我说</span><br>得够多的了。”',
		PrivateBirth: function (c) {
			var a = c.R,
				b = c.C;
	...
	(ostar = InheritO(CPlants, {
		...
		Produce:
			'海星果的触手可以轻易掀翻僵尸并造成混乱<p>攻击：<span style="color: #CC241D">较大</font><br>路径：<font color="#CC241D;">随机的撞击线</font></p>海星果永远保持着迷人的微笑，没人知道他那</font><br>么热爱转圈圈却不会头晕的秘密，有人说因为他</span><br>那双斗鸡眼只看一点才不会转晕。',
		PicArr: [
	...
	(oGun = InheritO(oPuffShroom, {
		...
		Tooltip: "轻型海底作战植物",
		Produce:
			'水枪草可以直接种在海底，但射程比较短。<p>Harm:<span style="color: #CC241D">小</font><br>射程：<font color="#CC241D;">短</font></p>自从水枪草得到了绝世的吐纳秘籍之后一直在</span><br>不断地练习着，希望自己能够突破三米的射程。',
		PrivateBirth: function (a) {
			a.BulletEle = NewImg(
				0,
				"images/Plants/gun/ShroomBullet.gif",
	...
	(oTTS = InheritO(CPlants, {
		...
		Produce:
			'荆棘海草会用力抓住靠近他的任何东西并拖入</font><br>地下。<p>Harm:<span style="color: CC241D">巨大</font><br>Scope:<font color="#CC241D">一格</font><br>Instructions:<font color="#CC241D;">一次性使用。</font></p>荆棘海草最近一次的表白又被捷足先登了，这</font><br>使他很伤心。不过很快他就重新振作起来并吸取</font><br>教训。一定要抓住机会!但他似乎对这句话理解</span><br>有误：他无论碰到什么都会死死地抓住。',
		CanGrow: function (e, d, f) {
			var c = d + "_" + f,
				b = oGd.$LF[d],
				a = f < 1 || f > 9;
